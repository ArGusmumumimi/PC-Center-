...
- เขียนรีวิวสินค้าและส่งข้อความติดต่อร้านค้าได้

Pain Points:
- เดินทางไปร้านค้าไม่สะดวก ต้องการสั่งซื้อออนไลน์ตลอด 24 ชั่วโมง
- ข้อมูลสเปคสินค้าในเว็บทั่วไปไม่ครบถ้วน ต้องเปิดหลายแหล่งเปรียบเทียบ
- ไม่สามารถตรวจสอบสถานะคำสั่งซื้อและเลขพัสดุได้ง่าย

Needs:
- เว็บไซต์ดีไซน์ทันสมัย ใช้งานง่าย Responsive ทุกอุปกรณ์
- ค้นหาสินค้าด้วยคีย์เวิร์ด กรองตามหมวดหมู่ แบรนด์ และเรียงลำดับราคา/คะแนนรีวิว
- มีรายละเอียดสเปคสินค้าครบถ้วน พร้อมรูปภาพประกอบ
...
- อัปเดตสถานะคำสั่งซื้อ (รอยืนยัน → กำลังจัดส่ง → จัดส่งแล้ว) ได้อย่างรวดเร็ว
- ดูข้อมูลลูกค้าเพื่อประกอบการจัดส่ง

Pain Points:
- การติดตามคำสั่งซื้อจำนวนมากแบบ manual ทำได้ยากและเสียเวลา
- ไม่มีระบบ Dashboard รวมศูนย์ข้อมูลให้ดูภาพรวมได้ทันที

Needs:
- Dashboard แสดงภาพรวมของคำสั่งซื้อและจำนวนสินค้าในระบบ
...
- จัดการหมวดหมู่สินค้า (เพิ่มหมวดหมู่ใหม่)
- บริหารจัดการผู้ใช้ระบบ (เพิ่มผู้ใช้ / แก้ไข Role / เปิด-ปิดสถานะบัญชี)
- ตรวจสอบภาพรวมยอดขายและรายงานสรุปของระบบ

Pain Points:
- การจัดการสินค้าจำนวนมากต้องมีระบบที่รองรับการค้นหาและแก้ไขข้อมูลได้รวดเร็ว
- ต้องการควบคุมสิทธิ์การเข้าถึงของผู้ใช้งานแต่ละระดับ (Customer / Staff / Manager)
...
- ระบบจัดการผู้ใช้ (เปลี่ยน Role, เปิด-ปิดสถานะ, เพิ่มผู้ใช้ใหม่)
- เข้าถึงทุกฟังก์ชันของ Staff (ดูคำสั่งซื้อ, อัปเดตสถานะ, ดูข้อมูลลูกค้า)
