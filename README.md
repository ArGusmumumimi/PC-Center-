...
| UAT-M02 | ระบบดูรายงานภาพรวมระบบ (Dashboard) | ✅ ผ่าน | - | - |
| UAT-M03 | ระบบจัดการสินค้าและสต็อกสินค้า | ✅ ผ่าน | - | - |
| UAT-M04 | ระบบดูข้อมูลลูกค้า (ที่อยู่, การติดต่อ) | ✅ ผ่าน | - | - |
| UAT-M05 | ระบบจัดการผู้ใช้ระบบ (ระงับสิทธิ์) | ✅ ผ่าน | - | - |

---

### 📊 สรุปผลการทดสอบ UAT
จากผลการทดสอบทั้งหมด **16 Test Cases** แบ่งตามกลุ่มผู้ใช้งาน ได้ผลลัพธ์ดังนี้:
