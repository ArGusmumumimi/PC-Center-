...
Needs:
- เว็บไซต์ดีไซน์ทันสมัย ใช้งานง่าย Responsive ทุกอุปกรณ์
...
จากขอบเขตของโครงงาน (Project Scope) ได้ทำการทดสอบระบบ (Test Cases) ทั้งหมด 15 รายการ เพื่อประเมินความสมบูรณ์ของการทำงาน ซึ่งผลการทดสอบมีรายละเอียดดังนี้:

### 👤 Persona: Customer (ลูกค้า)
| รหัสทดสอบ | รายการทดสอบ | สถานะการทดสอบ | ปัญหา / ข้อผิดพลาด | รายละเอียดของปัญหา |
| :---: | :--- | :---: | :--- | :--- |
| UAT-C01 | ระบบสมัครสมาชิกและเข้าสู่ระบบ | ✅ ผ่าน | - | - |
| UAT-C02 | ระบบค้นหาและกรองสินค้าตามหมวดหมู่ | ✅ ผ่าน | - | - |
| UAT-C03 | ระบบดูรายละเอียดสินค้า | ✅ ผ่าน | - | - |
| UAT-C04 | ระบบจัดการตะกร้าสินค้า | ✅ ผ่าน | - | - |
| UAT-C05 | ระบบสั่งซื้อสินค้าและชำระเงิน | ✅ ผ่าน | - | - |
| UAT-C06 | ประวัติการสั่งซื้อ | ✅ ผ่าน | - | - |
| UAT-C07 | ระบบติดตามสถานะคำสั่งซื้อ | ✅ ผ่าน | - | - |
| UAT-C08 | ระบบรีวิวสินค้า (เฉพาะที่เคยสั่งซื้อ) | ✅ ผ่าน | - | - |

### 🧑‍💼 Persona: Staff (พนักงาน)
| รหัสทดสอบ | รายการทดสอบ | สถานะการทดสอบ | ปัญหา / ข้อผิดพลาด | รายละเอียดของปัญหา |
| :---: | :--- | :---: | :--- | :--- |
| UAT-S01 | ระบบเข้าสู่ระบบ (Staff) | ✅ ผ่าน | - | - |
| UAT-S02 | ระบบดูรายการคำสั่งซื้อทั้งหมด | ✅ ผ่าน | - | - |
| UAT-S03 | ระบบอัปเดตสถานะคำสั่งซื้อ | ✅ ผ่าน | - | - |

### 👨‍💼 Persona: Manager (ผู้จัดการ)
| รหัสทดสอบ | รายการทดสอบ | สถานะการทดสอบ | ปัญหา / ข้อผิดพลาด | รายละเอียดของปัญหา |
| :---: | :--- | :---: | :--- | :--- |
| UAT-M01 | ระบบเข้าสู่ระบบ (Manager) | ✅ ผ่าน | - | - |
| UAT-M02 | ระบบจัดการสินค้าและสต็อกสินค้า | ✅ ผ่าน | - | - |
| UAT-M03 | ระบบดูข้อมูลลูกค้า (ที่อยู่, การติดต่อ) | ✅ ผ่าน | - | - |
| UAT-M04 | ระบบจัดการผู้ใช้ระบบ (ระงับสิทธิ์) | ✅ ผ่าน | - | - |

---

### 📊 สรุปผลการทดสอบ UAT
จากผลการทดสอบทั้งหมด **15 Test Cases** แบ่งตามกลุ่มผู้ใช้งาน ได้ผลลัพธ์ดังนี้:
...
**สรุปผลการประเมิน:** ระบบเว็บไซต์ E-Commerce "PC Center" สามารถทำงานได้ครบถ้วนตามขอบเขต (Project Scope) ที่ได้ออกแบบไว้ ทุกฟังก์ชันหลักทำงานได้อย่างถูกต้องตามเงื่อนไข (รวมถึงฟังก์ชันที่ได้รับการปรับปรุงล่าสุด เช่น ระบบชำระเงิน, การตรวจสอบสิทธิ์การรีวิว, และการจัดการข้อมูลต่างๆ) ระบบมีความสมบูรณ์ 100% และพร้อมสำหรับการส่งมอบโครงงานครับ
